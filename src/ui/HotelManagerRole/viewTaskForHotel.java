...
public class viewTaskForHotel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jLabel1);
        jLabel1.setBounds(260, 160, 242, 24);
        ...
        add(jLabel2);
        jLabel2.setBounds(660, 160, 320, 24);

        add(cmbTransportationOrg);
        cmbTransportationOrg.setBounds(720, 210, 216, 21);
        ...
        jPanel1.add(jLabel3);
        jLabel3.setBounds(420, 30, 479, 32);
        ...
        jPanel1.add(btnBack);
        btnBack.setBounds(50, 30, 102, 33);
