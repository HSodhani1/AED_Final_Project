...
public class manageRestaurantOrganisationPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(orgCombo);
        orgCombo.setBounds(490, 400, 232, 25);

        jLabel2.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel2.setText("NAME");
        add(jLabel2);
        jLabel2.setBounds(300, 450, 91, 24);

        nameField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(nameField);
        nameField.setBounds(490, 450, 232, 25);

        jLabel3.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel3.setText("CONTACT");
        add(jLabel3);
        jLabel3.setBounds(290, 510, 91, 24);

        contactField.setFont(new java.awt.Font("Lucida Grande", 0, 14)); // NOI18N
        add(contactField);
        contactField.setBounds(490, 510, 232, 25);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("CITY");
        add(jLabel4);
        jLabel4.setBounds(300, 580, 82, 24);
        ...
        cityNameTextField.setBounds(490, 569, 232, 30);
        ...
        jPanel1.add(jLabel5);
        jLabel5.setBounds(430, 30, 509, 32);
        ...
        backButton.setBounds(30, 30, 92, 33);
