...
public class healthClubServicesJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(yogaBtn);
        yogaBtn.setBounds(100, 350, 170, 27);
        ...
        add(massageBtn);
        massageBtn.setBounds(100, 430, 250, 27);
        ...
        medicalServiceBtn.setBounds(100, 520, 270, 27);
        ...
        add(jLabel6);
        jLabel6.setBounds(440, 530, 200, 16);
        ...
        add(dateField);
        dateField.setBounds(420, 170, 227, 26);
