...
public class eventsBookingJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(btnBack);
        btnBack.setBounds(33, 21, 100, 31);
        ...
        add(photoRadioBtn);
        photoRadioBtn.setBounds(40, 290, 200, 31);
        ...
        cateringRadioBtn.setBounds(40, 380, 111, 31);
        ...
        add(btnBookEvent);
        btnBookEvent.setBounds(440, 710, 141, 38);
        ...
        add(jLabel1);
        jLabel1.setBounds(90, 430, 210, 24);
        ...
        add(decorRadioBtn);
        decorRadioBtn.setBounds(40, 490, 210, 33);
        ...
        add(jLabel2);
        jLabel2.setBounds(50, 160, 98, 24);
        add(dateField);
        dateField.setBounds(300, 160, 200, 19);

        add(cmbOrg);
        cmbOrg.setBounds(300, 240, 200, 21);

        jLabel4.setFont(new java.awt.Font("Lucida Grande", 0, 18)); // NOI18N
        jLabel4.setText("BUSINESS EVENTS ");
        add(jLabel4);
        jLabel4.setBounds(50, 230, 180, 24);
        ...
        add(totalPrice);
        totalPrice.setBounds(70, 640, 130, 27);
