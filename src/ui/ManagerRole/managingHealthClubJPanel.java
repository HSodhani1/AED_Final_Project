...
public class managingHealthClubJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setLayout(null);
        add(txtPassword);
        txtPassword.setBounds(337, 604, 125, 19);
        add(txtUsername);
        txtUsername.setBounds(337, 564, 125, 19);

        btnUpdate.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnUpdate.setText("UPDATE");
        add(btnUpdate);
        btnUpdate.setBounds(363, 670, 99, 31);

        jLabel6.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel6.setText("PHONE NUMBER");
        add(jLabel6);
        jLabel6.setBounds(134, 522, 145, 22);
        ...
        add(cmbEnterprise);
        cmbEnterprise.setBounds(337, 394, 125, 28);

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel3.setText("MANAGER ID");
        add(jLabel3);
        jLabel3.setBounds(134, 482, 145, 22);
        add(txtManager);
        txtManager.setBounds(337, 445, 125, 19);
        add(txtManagerID);
        txtManagerID.setBounds(337, 485, 125, 19);

        jLabel5.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel5.setText("PASSWORD");
        add(jLabel5);
        jLabel5.setBounds(134, 604, 102, 22);

        btnAdd.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btnAdd.setText("ADD");
        add(btnAdd);
        btnAdd.setBounds(248, 670, 80, 31);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("MANAGER");
        add(jLabel1);
        jLabel1.setBounds(134, 440, 145, 22);

        jLabel4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel4.setText("USERNAME");
        add(jLabel4);
        jLabel4.setBounds(134, 564, 102, 22);
        add(txtPhoneNumber);
        txtPhoneNumber.setBounds(337, 527, 125, 19);

        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel2.setText("ENTERPRISE");
        add(jLabel2);
        jLabel2.setBounds(134, 397, 145, 22);
        ...
        add(btnDelete);
        btnDelete.setBounds(970, 341, 95, 31);
        ...
        add(jScrollPane1);
        jScrollPane1.setBounds(38, 140, 1027, 191);
